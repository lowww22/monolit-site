...
export const metadata: Metadata = {
  ...
  description:
    "Купить товарный бетон и раствор в Глазове и Игре. Приём вагонов и выгрузка щебня, продажа цемента. ООО «Монолит» — крупнейший бетонный завод Глазовского района, до 200 м³/час. Ежедневно 8:00–18:00.",
  keywords: [
    "бетон Глазов",
    "купить бетон Глазов",
    ...
    "бетон Игра",
    "купить цемент Глазов",
    "цемент Глазов",
    "выгрузка щебня",
    "приём вагонов щебень",
